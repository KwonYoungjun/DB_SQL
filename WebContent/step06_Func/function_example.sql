...
--첫 글자만 대문자로 출력
--[1] initcap(필드명)
select id, deptno1, deptno2 from student;
...
--log() 함수 : e = 2.718...
select log(2,8) from dual; -- log2(8) --> 2.9999...;		
select log(e,8) form dual; -- 자연로그 -> 2.079...

--exp() 함수
select exp(2.07944) from - 7.99998
...
WHERE HIREDATE=TO_DATE(19810220,'YYYY-MM-DD'); --'YYYYMMDD'
-- 숫자 형식으로 변환
...
-- nvl2(값1,값2,값3) : 값1이 null이면 값3, null이 아니면 값2 수행
