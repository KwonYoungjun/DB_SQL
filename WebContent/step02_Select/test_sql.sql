...
create table professor(
 profno number(4) primary key,		-- 교수 번호 : 기본키
...
create table student( 
  ...
  grade number check(grade between 1 and 6), --등급()
...
insert into student values (
9716,'허우2','wooya2703',1,'7902232116784',to_date('1978-02-23','YYYY-MM-DD'),'02)6122-2345',163,61,103,null,null);
